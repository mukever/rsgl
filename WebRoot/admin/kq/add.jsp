...
<BODY   scroll="yes">
	   <TABLE class=gridView id=ctl00_ContentPlaceHolder2_GridView1 style="WIDTH: 100%; BORDER-COLLAPSE: collapse" cellSpacing=0 rules=all border=1>
		...
		<form name="form1" action="<%=basePath %>ComAction.do" method="post" onsubmit="return check()">
		  ...
		  <TR  align="center"  >
			<TD width=40%   class=gridViewItem align=right>考勤类型：</TD>
		  ...
		  <TR  align="center"  >
			<TD width=40%   class=gridViewItem align=right>奖励金额：</TD>
			<TD align=left><input type=text size=30 name=jlje value="<%=jlje %>" > </TD>
		  </TR>
		  <TR  align="center"  >
			<TD width=40%   class=gridViewItem align=right>惩罚金额：</TD>
			<TD align=left><input type=text size=30 name=cfje value="<%=cfje %>"  > </TD>
		  </TR>
		  <TR  align="center"  >
			<TD width=40%   class=gridViewItem align=right>时间：</TD>
		   ...
		   <TR  align="center"  >
			<TD width=40%   class=gridViewItem align=right>详细说明：</TD>
