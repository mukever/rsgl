    ...
    <TBODY>
      ...
      <TR>
            ...
            <TABLE class=gridView id=ctl00_ContentPlaceHolder2_GridView1 style="WIDTH: 100%; BORDER-COLLAPSE: collapse" cellSpacing=0 rules=all border=1>
              <TBODY>
                <TR>
                  ...
                  <TH class=gridViewHeader scope=col>人事专员Id</TH>
                ...
                <%}}else{%>	
		  		<TR>
					<TD class=gridViewItem colspan=5 align=center>当前还没有添加人事专员</TD>
		  		</TR>
				<%} %> 
              </TBODY>
            </TABLE>
	   ...
	   <TABLE class=gridView id=ctl00_ContentPlaceHolder2_GridView1 style="WIDTH: 100%; BORDER-COLLAPSE: collapse" cellSpacing=0 rules=all border=1>
		  <TBODY>
		  <TR align="center">
			<TD class=gridViewItem height=23 colspan="2">增加人事专员</TD>
		  </TR>
		  <TR align="center">
			<TD width="40%" align="right"  class=gridViewItem>人事专员名：</TD><input type=hidden name=ra value="">
